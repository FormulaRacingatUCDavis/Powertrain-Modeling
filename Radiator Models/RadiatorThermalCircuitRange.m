function [WaterOutletTemp1, WaterOutletTemp2, NumberOfTransferUnits, Effectiveness,AttainableHeatTransferRate]....
     = RadiatorThermalCircuitRange(WaterInletTemp,...
   AirInletTemp, AirFreeStreamVelocity)
...
%% Fluid Parameters 
  ...
  AirMassFlow           = AirDensity.*RadiatorZ.*RadiatorY.*AirFreeStreamVelocity;                                                    %.15; % Air mass flow from CFD (kg/s)
